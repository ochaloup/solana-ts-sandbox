import { AccountState, createInitializeDefaultAccountStateInstruction, createInitializeMint2Instruction, createInitializeMintCloseAuthorityInstruction,  ExtensionType, getMintLen, TOKEN_2022_PROGRAM_ID, createInitializePermanentDelegateInstruction } from '@solana/spl-token';
...
describe('Solana', () => {
  ...
  it('mint token 2022', async () => {
          ...
          await connection.requestAirdrop(admin, 111 * LAMPORTS_PER_SOL);
             ...
             const extensions = [ExtensionType.MintCloseAuthority, ExtensionType.PermanentDelegate, ExtensionType.DefaultAccountState];
            ...
            const transaction = new Transaction().add(
                SystemProgram.createAccount({
                 ...
                 createInitializePermanentDelegateInstruction(mint, admin, TOKEN_2022_PROGRAM_ID),
                createInitializeMintCloseAuthorityInstruction(mint, admin, TOKEN_2022_PROGRAM_ID),
